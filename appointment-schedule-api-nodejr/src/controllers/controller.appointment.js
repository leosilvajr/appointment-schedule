...
async function ListarByUser (req, res){
    const id_user = req.id_user; //Quando a gente esta validando o token, ele cria uma variavel global chamada req, onde tem um id_user, por isso conseguimos pegar o id do user aqui.
